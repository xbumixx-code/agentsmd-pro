...
const TRANSLATIONS = {
  en: {
    ...
    'landing.sub': 'Write a project description — get a complete instruction file for AI agents. Stack, rules, commands — all ready to paste.',
    'hero.what_is': 'What is this? →',
    'hero.modal_title': 'How AgentsMD works',
    'hero.modal_close': 'Got it, let\'s go →',
    'hero.counter_label': 'AGENTS.md files generated',
  ...
  ru: {
    ...
    'landing.sub': 'Напишите описание проекта — получите полный файл инструкций для AI-агентов. Структура, правила, стек, команды — всё готово к вставке.',
    'hero.what_is': 'Что это такое? →',
    'hero.modal_title': 'Как работает AgentsMD',
    'hero.modal_close': 'Понятно, поехали →',
    'hero.counter_label': 'файлов AGENTS.md создано',
